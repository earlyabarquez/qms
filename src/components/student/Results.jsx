...
export default function Results() {
  ...
  // Check if any situational questions are still pending grading
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div
          style={{ ...styles.gradePill, color, borderColor: color }}
      ...
      <div style={styles.questionList}>
        {questions.filter((_, idx) => idx < (submission.answers?.length ?? 0)).map((q, idx) => {
          ...
          const correct = isSituational ? gradedAnswer?.correct === true : studentAnswer === q.correctAnswer;
      ...
      <motion.div
        ...
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ delay: 0.6 + questions.length * 0.07 }}
      >
        <motion.button
          style={styles.homeBtn}
          onClick={() => navigate("/student")}
          whileHover={{ scale: 1.04, boxShadow: "0 4px 16px rgba(79,70,229,0.35)" }}
          whileTap={{ scale: 0.97 }}
        >
...
const styles = {
  ...
  backBtn: {
    ...
    color: "#6b7280", fontSize: "13px", fontWeight: "500", padding: "0 0 1.5rem",
  },
  scoreCard: {
  ...
  gradePill: {
    ...
    padding: "4px 22px", borderRadius: "99px", border: "2px solid", marginBottom: "12px",
  },
  ...
  reviewTitle: {
    ...
    fontSize: "18px", fontWeight: "700", color: "#1e1b4b", margin: "0 0 16px",
  },
  ...
  teacherNote: {
    fontSize: "13px", fontWeight: "400", margin: "4px 0 0",

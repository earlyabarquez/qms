            ...
            <div key={q.id} style={questionCardStyle(hasAnswer)}>
              <div style={styles.qHeader}>
                <span style={qNumStyle(hasAnswer)}>
                  {hasAnswer ? <Check size={13} strokeWidth={3} /> : `Q${qIdx + 1}`}
                </span>
                <div style={{ flex: 1 }}>
...
const styles = {
  ...
  progressFill: {
    ...
    borderRadius: "99px", transition: "width 0.25s ease",
  },
  questionList: {
    display: "flex", flexDirection: "column", gap: "18px", marginBottom: "2rem",
  },
